...
import { Result } from '../services/check-parser/package-files/result.js';
...
export declare class Session {
    ...
    static workspace: Result<Workspace, Error>;
