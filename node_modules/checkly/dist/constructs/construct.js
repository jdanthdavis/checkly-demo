...
export class Construct {
     ...
     */
    earlyDiagnostics = new Diagnostics();
    /**
    ...
    constructor(type, logicalId, physicalId, member) {
        if (typeof logicalId !== 'string') {
            this.earlyDiagnostics.add(new InvalidPropertyValueDiagnostic('logicalId', new Error(`Expected a string but received type "${typeof logicalId}".`)));
