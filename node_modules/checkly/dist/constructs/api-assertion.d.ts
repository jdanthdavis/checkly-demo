...
export declare class AssertionBuilder {
     ...
     */
    static jsonBody(property?: string): GeneralAssertionBuilder<ApiAssertionSource, string | number | boolean>;
    /**
     ...
     */
    static headers(property?: string, regex?: string): GeneralAssertionBuilder<ApiAssertionSource, string | number | boolean>;
    /**
     ...
     */
    static textBody(property?: string): GeneralAssertionBuilder<ApiAssertionSource, string | number | boolean>;
    /**
