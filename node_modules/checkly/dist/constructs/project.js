...
export class Project extends Construct {
    ...
    addResource(type, logicalId, resource) {
        ...
        if (existingResource) {
            ...
            // offending construct.
            this.earlyDiagnostics.add(new ConstructDiagnostic(resource, new InvalidPropertyValueDiagnostic('logicalId', new Error(`A ${type} with logicalId "${logicalId}" already exists.`))));
            return;
        }
