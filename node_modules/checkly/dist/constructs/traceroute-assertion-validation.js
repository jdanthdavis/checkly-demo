...
import { hopCountGrammar, packetLossGrammar, tracerouteResponseTimeComparisons, } from './traceroute-assertion-grammar.js';
...
const anyResponseTimeComparison = Object.assign({}, ...Object.values(tracerouteResponseTimeComparisons));
/**
...
export function validateTracerouteAssertion(diagnostics, assertion, index) {
    ...
    switch (assertion.source) {
        ...
        case 'PACKET_LOSS':
            ...
            validateComparison(diagnostics, assertion, location, assertion.source === 'HOP_COUNT' ? hopCountComparisons : packetLossComparisons);
            break;
        default:
