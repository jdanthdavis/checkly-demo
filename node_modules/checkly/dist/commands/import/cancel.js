...
import { reportNoCandidatePlans, selectPlansOrExit, validatePlanFlagsOrExit, } from '../../helpers/import-plan-selection.js';
export default class ImportCancelCommand extends AuthCommand {
    ...
    async run() {
        ...
        const { config: configFilename, all, 'plan-id': planId, } = flags;
        ...
        const plans = await selectPlansOrExit(this, cancelablePlans, { all, planId }, 'cancel', () => this.#selectPlans(cancelablePlans));
