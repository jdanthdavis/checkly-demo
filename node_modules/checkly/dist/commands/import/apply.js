...
export default class ImportApplyCommand extends AuthCommand {
    ...
    async run() {
        ...
        const { config: configFilename, 'plan-id': planId, 'no-commit': noCommit, } = flags;
        ...
        const plan = await selectPlanOrExit(this, unappliedPlans, planId, 'apply', () => this.#selectPlan(unappliedPlans));
