...
export default class ImportCommitCommand extends AuthCommand {
    ...
    async run() {
        ...
        const { config: configFilename, 'plan-id': planId, } = flags;
        ...
        const plan = await selectPlanOrExit(this, uncommittedPlans, planId, 'commit', () => this.#selectPlan(uncommittedPlans));
