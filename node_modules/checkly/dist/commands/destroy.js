...
export default class Destroy extends AuthCommand {
    ...
    async run() {
        ...
        const { config: configFilename, 'preserve-resources': preserveResources, 'cancel-in-progress-deployment': cancelInProgress, } = flags;
        ...
        try {
            ...
            if (err instanceof ProjectDeployCancelledError) {
                ...
                this.style.longError('An operation for this project is still in progress.', 'Try again later, or re-run with `--cancel-in-progress-deployment` to '
