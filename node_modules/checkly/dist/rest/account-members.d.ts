...
declare class AccountMembers {
    ...
    getAll(params?: AccountMembersListParams): Promise<import("axios").AxiosResponse<AccountMembersResponse, any, {}, any>>;
    updateRole(userId: string, role: AccountMemberUpdateRole): Promise<import("axios").AxiosResponse<ActiveAccountMember, any, {}, any>>;
    delete(userId: string): Promise<import("axios").AxiosResponse<void, any, {}, any>>;
}
