...
export declare const batchQuickRangeValues: BatchQuickRange[];
declare class BatchAnalytics {
    api: AxiosInstance;
    constructor(api: AxiosInstance);
    get(checkIds: string[], quickRange?: BatchQuickRange): Promise<import("axios").AxiosResponse<BatchAnalyticsResult[], any, {}, any>>;
}
