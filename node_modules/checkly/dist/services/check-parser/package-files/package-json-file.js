...
export class PackageJsonFile {
    ...
    resolveExportPath(exportPath, conditions) {
        const resolver = PathResolver.createFromPaths(this.basePath, this.#resolveConditionalTargets(this.jsonFile.data.exports ?? {}, conditions));
     ...
     */
    resolveImportPath(importPath, conditions) {
        const resolver = PathResolver.createFromPaths(this.basePath, this.#resolveConditionalTargets(this.jsonFile.data.imports ?? {}, conditions));
    ...
    #resolveConditionalTargets(map, conditions) {
    ...
    static make(filePath, data) {
        ...
        const jsonFile = new JsonSourceFile(sourceFile, data);
    ...
    static async loadFromSourceFile(sourceFile) {
        const jsonSourceFile = await JsonSourceFile.loadFromSourceFile(sourceFile);
        if (!jsonSourceFile) {
            return;
        }
