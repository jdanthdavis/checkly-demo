...
import { PackageFilesResolver } from './package-files/resolver.js';
...
export class Parser {
    ...
    async parseFileContent(filePath, content) {
        const cached = this.#parseCache.get(filePath);
        if (cached !== undefined) {
            return await cached;
        }
