export declare const REFERENCES: readonly [{
    ...
    readonly id: "configure-grpc-monitors";
    readonly description: "gRPC Monitor construct (`GrpcMonitor`) with status code, response message, and health-check assertions";
}, {
    readonly id: "configure-ssl-monitors";
    readonly description: "SSL Monitor construct (`SslMonitor`) with certificate expiry, chain trust, and TLS version assertions";
}, {
    readonly id: "configure-traceroute-monitors";
    readonly description: "Traceroute Monitor construct (`TracerouteMonitor`) with hop count and packet loss assertions";
}, {
    ...
    readonly description: "Email (`EmailAlertChannel`), Phone (`PhoneCallAlertChannel`), Slack App (`SlackAppAlertChannel`), Telegram (`TelegramAlertChannel`), Incident.io (`IncidentioAlertChannel`), Microsoft Teams (`MSTeamsAlertChannel`), and other alert channels";
}, {
...
export declare const INVESTIGATE_REFERENCES: readonly [{
    ...
    readonly description: "Inspect checks (`checks list`, `checks get`), retry attempts, result assets, and run on-demand monitoring or test sessions";
}, {
    readonly id: "investigate-alerting";
    readonly description: "Inspect effective alerting behavior for a check across check-local, group, global, and alert-channel evidence";
}, {
...
export declare const MANAGE_REFERENCES: readonly [{
    ...
    readonly id: "manage-account-members";
    readonly description: "List account members and pending invites (`members`), update member roles, and delete members";
}];
...
export declare const ACTIONS: readonly [{
    ...
    readonly description: "Open incidents and lead customer communications via status pages.";
    readonly references: readonly [{
        readonly id: "communicate-incidents";
        readonly description: "Incident lifecycle (`incidents create`, `update`, `resolve`, `list`) and status pages";
    }];
    ...
    readonly id: "manage";
    readonly description: "Understand your account plan, entitlements, feature limits, members, and pending invites.";
    readonly references: readonly [{
        readonly id: "manage-plan";
        readonly description: "Check account plan, entitlements, feature limits, and available locations (`account plan`)";
    }, {
