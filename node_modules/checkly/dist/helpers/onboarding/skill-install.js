...
export function runSkillInstallStep(log) {
...
async function runAgentInstall(log) {
...
async function runInteractiveInstall(log) {
    log('');
...
export async function refreshSkill(skillPath, log) {
    try {
