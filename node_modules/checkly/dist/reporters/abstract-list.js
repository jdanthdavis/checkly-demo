...
export default class AbstractListReporter {
    ...
    _printSummary(opts = {}) {
        ...
        for (const [sourceFile, checkMap] of this.checkFilesMap.entries()) {
            if (includeCheckTitles && sourceFile)
